// Automatically generated on 2017-08-07T14:38:41+03:00
...
xdr.struct("AccountEntry", [
  ...
  ["signers", xdr.varArray(xdr.lookup("Signer"), 50)],
...
//
// ===========================================================================
xdr.union("CreateAccountOpBody", {
  switchOn: xdr.lookup("AccountType"),
  switchName: "accountType",
  switches: [
    ["accountAnonymousUser", xdr.void()],
  ],
  arms: {
  },
  defaultArm: xdr.void(),
...
xdr.struct("CreateAccountOp", [
  ...
  ["body", xdr.lookup("CreateAccountOpBody")],
]);
...
xdr.union("OperationBody", {
  ...
  switches: [
    ...
    ["emission", "emissionOp"],
    ["settlement", "settlementOp"],
    ["spendFee", "spendFeeOp"],
    ["setFee", "setFeeOp"],
    ["restrictAccount", "restrictAccountOp"],
  ],
  arms: {
    ...
    emissionOp: xdr.lookup("EmissionOp"),
    settlementOp: xdr.lookup("SettlementOp"),
    spendFeeOp: xdr.lookup("SpendFeeOp"),
    setFeeOp: xdr.lookup("SetFeeOp"),
    restrictAccountOp: xdr.lookup("RestrictAccountOp"),
  },
});
...
//
// ===========================================================================
xdr.enum("EmissionResultCode", {
  emissionSuccess: 0,
  emissionMalformed: -1,
  emissionSrcNotAuthorized: -2,
  emissionDestFull: -3,
  emissionTotalEmissionFull: -4,
  emissionDestBlocked: -5,
});
...
//
// ===========================================================================
xdr.union("EmissionResult", {
  switchOn: xdr.lookup("EmissionResultCode"),
  switchName: "code",
  switches: [
    ["emissionSuccess", xdr.void()],
  ],
  arms: {
  },
  defaultArm: xdr.void(),
...
//
// ===========================================================================
xdr.enum("SettlementResultCode", {
  settlementSuccess: 0,
  settlementMalformed: -1,
  settlementSrcNotAuthorized: -2,
  settlementUnderfunded: -3,
});
...
//
// ===========================================================================
xdr.union("SettlementResult", {
  switchOn: xdr.lookup("SettlementResultCode"),
  switchName: "code",
  switches: [
    ["settlementSuccess", xdr.void()],
  ],
  arms: {
  },
  defaultArm: xdr.void(),
...
//
// ===========================================================================
xdr.enum("SpendFeeResultCode", {
  spendFeeSuccess: 0,
  spendFeeMalformed: -1,
  spendFeeUnderfunded: -2,
  spendFeeSrcNotAuthorized: -3,
  spendFeeNoDestination: -4,
  spendFeeSignerNotAuthorized: -5,
  spendFeeDestBlocked: -6,
});
...
//
// ===========================================================================
xdr.union("SpendFeeResult", {
  switchOn: xdr.lookup("SpendFeeResultCode"),
  switchName: "code",
  switches: [
    ["spendFeeSuccess", xdr.void()],
  ],
  arms: {
  },
  defaultArm: xdr.void(),
...
//
// ===========================================================================
xdr.enum("SetFeeResultCode", {
  setFeeSuccess: 0,
  setFeeMalformed: -1,
  setFeeSrcNotAuthorized: -2,
  setFeeSignerNotAuthorized: -3,
});
...
//
// ===========================================================================
xdr.union("SetFeeResult", {
  switchOn: xdr.lookup("SetFeeResultCode"),
  switchName: "code",
  switches: [
    ["setFeeSuccess", xdr.void()],
  ],
  arms: {
  },
  defaultArm: xdr.void(),
...
//
// ===========================================================================
xdr.enum("RestrictAccountResultCode", {
  restrictAccountSuccess: 0,
  restrictAccountMalformed: -1,
  restrictAccountSrcNotAuthorized: -2,
  restrictAccountSignerNotAuthorized: -3,
  restrictAccountBadFlag: -4,
  restrictAccountUnknownFlag: -5,
  restrictAccountNoDestination: -6,
});
...
//
// ===========================================================================
xdr.union("RestrictAccountResult", {
  switchOn: xdr.lookup("RestrictAccountResultCode"),
  switchName: "code",
  switches: [
    ["restrictAccountSuccess", xdr.void()],
  ],
  arms: {
  },
  defaultArm: xdr.void(),
...
xdr.union("OperationResultTr", {
  ...
  switches: [
    ...
    ["spendFee", "spendFeeResult"],
    ["setFee", "setFeeResult"],
    ["restrictAccount", "restrictAccountResult"],
  ],
  arms: {
    ...
    emissionResult: xdr.lookup("EmissionResult"),
    settlementResult: xdr.lookup("SettlementResult"),
    spendFeeResult: xdr.lookup("SpendFeeResult"),
    setFeeResult: xdr.lookup("SetFeeResult"),
    restrictAccountResult: xdr.lookup("RestrictAccountResult"),
  },
});
