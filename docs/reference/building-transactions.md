...
## [TransactionBuilder](https://github.com/stellar/js-base/blob/master/src/transaction_builder.js)
...
The transaction will use the current sequence number of the given [Account](https://github.com/stellar/js-base/blob/master/src/account.js) object as its sequence number and increments
...
See [operation.js](https://github.com/stellar/js-base/blob/master/src/operation.js) for a list of possible operations you can add.
...
This will return a fully constructed [Transaction](https://github.com/stellar/js-base/blob/master/src/transaction.js).
...
by passing a [memo](https://github.com/stellar/js-base/blob/master/src/memo.js) object when you construct the TransactionBuilder.
...
## [Transaction](https://github.com/stellar/js-base/blob/master/src/transaction.js)
