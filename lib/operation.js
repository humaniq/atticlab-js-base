...
var BlockIncomingFlag = 1 << 3;
exports.BlockIncomingFlag = BlockIncomingFlag;
var BlockOutgoingFlag = 1 << 4;

exports.BlockOutgoingFlag = BlockOutgoingFlag;
/**
  ...
  _createClass(Operation, null, {
    ...
    emission: {
      ...
      value: function emission(opts) {
        ...
        var emission = new xdr.EmissionOp(attributes);
    ...
    settlement: {
      ...
      value: function settlement(opts) {
        if (!this.isValidAmount(opts.amount)) {
          throw new TypeError(Operation.constructAmountRequirementsError("amount"));
        }
        ...
        var settlement = new xdr.SettlementOp(attributes);
    ...
    setOptions: {
      ...
      value: function setOptions(opts) {
        ...
        if (opts.signer) {
          ...
          var key = undefined;
          var signerType = opts.signer.signerType;
          var setValues = 0;
          ...
          attributes.signer = new xdr.Signer({ key: key, weight: weight, signerType: signerType });
        }
    ...
    spendFee: {
      ...
      value: function spendFee(opts) {
        ...
        var spendFeeOp = new xdr.SpendFeeOp(attributes);
    ...
    setFee: {
      ...
      value: function setFee(opts) {

        var attributes = {};
        attributes.baseFee = opts.baseFee;

        var setFeeOp = new xdr.SetFeeOp(attributes);
    ...
    restrictAccount: {
      ...
      value: function restrictAccount(opts) {
        var attributes = {};
        ...
        var restrictAccountOp = new xdr.RestrictAccountOp(attributes);
    ...
    _signerTypeFromNumber: {
      value: function _signerTypeFromNumber(rawSignerType) {
    ...
    _isValidSignerType: {
      value: function _isValidSignerType(rawSignerType) {
